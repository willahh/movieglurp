(ns movieglurp.front.home
  (:require [movieglurp.component.card :as card]
            [movieglurp.front.main :as main]
            [movieglurp.model.movie.movie-dao :as movie-dao]
            [movieglurp.model.movie.movie-schema :refer [map-movie-record-to-card-record]]
            [movieglurp.process.crud.list :as crud-list]
            [movieglurp.service.session.session :refer [merge-params-session]]
