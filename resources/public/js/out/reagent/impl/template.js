...
var G__25737 = o;
(G__25737[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__25741 = o;
(G__25741[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__25743__i < G__25743__a.length) {G__25743__a[G__25743__i] = arguments[G__25743__i + 0]; ++G__25743__i;}
  args = new cljs.core.IndexedSeq(G__25743__a,0,null);
} 
...
var G__25746 = props;
var G__25746__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__25746,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__25746);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__25746__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__25747){
...
var props = map__25748__$1;
var class$ = cljs.core.get.call(null,map__25748__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__25750){
...
var on_write = cljs.core.get.call(null,map__25751__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__25751,map__25751__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__25751,map__25751__$1,on_write))
);
} else {
...
var G__25754 = jsprops;
(G__25754["defaultValue"] = value);

(G__25754["onChange"] = ((function (G__25754,v,value,on_change){
return (function (p1__25753_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__25753_SHARP_);
});})(G__25754,v,value,on_change))
);
...
var vec__25757 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__25757,(0),null);
var id = cljs.core.nth.call(null,vec__25757,(1),null);
var class$ = cljs.core.nth.call(null,vec__25757,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___25761 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___25761 == null)){
} else {
var key_25762 = temp__5461__auto___25761;
(jsprops["key"] = key_25762);
}
...
var temp__5461__auto___25763 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___25763 == null)){
} else {
var key_25764 = temp__5461__auto___25763;
reagent.impl.template.oset.call(null,jsprops,"key",key_25764);
}
...
var G__25765 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__25765["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq25768){
var G__25769 = cljs.core.first.call(null,seq25768);
var seq25768__$1 = cljs.core.next.call(null,seq25768);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25769,seq25768__$1);
});
...
break;
default:
var G__25775 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__25775;
continue;
...
var n__4376__auto___25777 = a.length;
var i_25778 = (0);
while(true){
if((i_25778 < n__4376__auto___25777)){
(a[i_25778] = reagent.impl.template.as_element.call(null,(a[i_25778])));

var G__25779 = (i_25778 + (1));
i_25778 = G__25779;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4376__auto___25780 = a.length;
var i_25781 = (0);
while(true){
if((i_25781 < n__4376__auto___25780)){
var val_25782 = (a[i_25781]);
if(((cljs.core.vector_QMARK_.call(null,val_25782)) && ((reagent.impl.template.key_from_vec.call(null,val_25782) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_25781] = reagent.impl.template.as_element.call(null,val_25782));

var G__25783 = (i_25781 + (1));
i_25781 = G__25783;
continue;
} else {
}
...
var ctx = ({});
var vec__25784 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__25784,(0),null);
var derefed = cljs.core.nth.call(null,vec__25784,(1),null);
...
var G__25787 = (cljs.core.count.call(null,argv) - first_child);
switch (G__25787) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__25787){
...
//# sourceMappingURL=template.js.map?rel=1529089809565
