...
var G__21824 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__21824;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__21825 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__21825,ch);
...
if(("\\" === ch__$1)){
var ch_21826__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_21826__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_21826__$2);
} else {
}

var G__21827 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__21827;
continue;
}
}
...
var vec__21835 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__21835,(0),null);
var start_column = cljs.core.nth.call(null,vec__21835,(1),null);
...
var G__21838 = cljs.core.conj_BANG_.call(null,a,form);
a = G__21838;
continue;
}
}
...
var _STAR_read_delim_STAR_21839 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_21839;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__21840 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__21840,(0),null);
var start_column = cljs.core.nth.call(null,vec__21840,(1),null);
...
var vec__21843 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__21843,(0),null);
var end_column = cljs.core.nth.call(null,vec__21843,(1),null);
...
var vec__21846 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__21846,(0),null);
var start_column = cljs.core.nth.call(null,vec__21846,(1),null);
...
var vec__21849 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__21849,(0),null);
var end_column = cljs.core.nth.call(null,vec__21849,(1),null);
...
var sb = (function (){var G__21858 = (new goog.string.StringBuffer());
G__21858.append(initch);
...
var G__21860 = (function (){var G__21859 = sb;
G__21859.append(ch);

return G__21859;
})();
var G__21861 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__21860;
ch = G__21861;
continue;
}
...
switch (G__21864) {
case "\\":
var G__21868 = (function (){var G__21865 = sb;
G__21865.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__21865;
})();
var G__21869 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__21868;
ch = G__21869;
continue;
...
break;
default:
var G__21870 = (function (){var G__21866 = sb;
G__21866.append(ch);

return G__21866;
})();
var G__21871 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__21870;
ch = G__21871;
continue;
...
var vec__21872 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__21872,(0),null);
var end_column = cljs.core.nth.call(null,vec__21872,(1),null);
...
var vec__21875 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__21875,(0),null);
var column = cljs.core.nth.call(null,vec__21875,(1),null);
...
var vec__21880 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__21880,(0),null);
var column = cljs.core.nth.call(null,vec__21880,(1),null);
...
var vec__21885 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__21885,(0),null);
var column = cljs.core.nth.call(null,vec__21885,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__21890 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__21890,(0),null);
var start_column = cljs.core.nth.call(null,vec__21890,(1),null);
...
var vec__21893 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__21893,(0),null);
var end_column = cljs.core.nth.call(null,vec__21893,(1),null);
...
var G__21896 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__21896,true,null,opts,pending_forms);
...
var G__21897 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__21897)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__21897)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__21897)){
...
var _STAR_suppress_read_STAR_21898 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_21898;
}});
...
var G__21899 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__21899,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__21899,rdr,first_line);
...
var G__21903 = matched;
var G__21904 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__21903;
finished = G__21904;
continue;
} else {
...
var _STAR_suppress_read_STAR_21905 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_21905;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env21906 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__21907 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__21907,"(");
...
var G__21908 = (i + (1));
var G__21909 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3922__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env21906;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__21910 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__21910);
...
var G__21911 = cljs.core.next.call(null,s__$1);
var G__21912 = ret;
s__$1 = G__21911;
r = G__21912;
continue;
...
var G__21913 = cljs.core.next.call(null,s);
var G__21914 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__21913;
key_vals = G__21914;
continue;
} else {
...
var gensym_env21918 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env21918;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__21919 = token;
var G__21919__$1 = (((G__21919 == null))?null:cljs.core.subs.call(null,G__21919,(1)));
var G__21919__$2 = (((G__21919__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__21919__$1));
var G__21919__$3 = (((G__21919__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__21919__$2));
var G__21919__$4 = (((G__21919__$3 == null))?null:cljs.core.symbol.call(null,G__21919__$3));
if((G__21919__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__21919__$4);
}
})():(function (){var G__21920 = token;
var G__21920__$1 = (((G__21920 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__21920));
if((G__21920__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__21920__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
}catch (e21927){if((e21927 instanceof Error)){
var e = e21927;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__21931,reader){
...
var eof = cljs.core.get.call(null,map__21932__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq21938){
var G__21939 = cljs.core.first.call(null,seq21938);
var seq21938__$1 = cljs.core.next.call(null,seq21938);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21939,seq21938__$1);
});


//# sourceMappingURL=reader.js.map?rel=1529089804107
