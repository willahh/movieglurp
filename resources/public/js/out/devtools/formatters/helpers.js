...
var G__23007 = devtools.prefs.pref.call(null,v);
v = G__23007;
continue;
} else {
return v;
...
}catch (e23010){var _e__22024__auto__ = e23010;
return false;
}})();
...
}catch (e23014){var _e__22024__auto__ = e23014;
return false;
}})();
...
}catch (e23016){var _e__22024__auto__ = e23016;
return false;
}}
}
});
...
var vec__23018 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__23018,(0),null);
var name = cljs.core.nth.call(null,vec__23018,(1),null);
...
return cljs.core.some.call(null,(function (p1__23021_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__23021_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1529089805089
