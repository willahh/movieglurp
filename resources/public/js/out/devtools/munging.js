...
var o22905 = temp__5455__auto__;
var temp__5455__auto____$1 = (o22905["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o22906 = temp__5455__auto____$1;
return (o22906["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22017__auto__ = f;
return (o__22017__auto__["toString"]).call(o__22017__auto__);
} else {
return "";
}
}catch (e22907){var _ = e22907;
return "";
}});
...
try{var o__22017__auto___22909 = t;
(o__22017__auto___22909["cljs$lang$ctorPrWriter"]).call(o__22017__auto___22909,t,writer);
}catch (e22908){var __22910 = e22908;
}
...
var char_code = (function (){var o__22017__auto__ = (new String(char$));
return (o__22017__auto__["charCodeAt"]).call(o__22017__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22017__auto__ = String;
return (o__22017__auto__["fromCharCode"]).call(o__22017__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22911 = num_code;
switch (G__22911) {
case (1):
return (185);
...
var o__22017__auto__ = String;
return (o__22017__auto__["fromCharCode"]).call(o__22017__auto__,superscript_code);
});
/**
...
}catch (e22913){var _e__22024__auto__ = e22913;
return false;
}})())){
...
var vec__22914 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22914,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o22917 = temp__5455__auto__;
var temp__5455__auto____$1 = (o22917["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o22918 = temp__5455__auto____$1;
return (o22918["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22921){
var vec__22922 = p__22921;
var ns_detector = cljs.core.nth.call(null,vec__22922,(0),null);
...
var G__22928 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22929 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22928;
remaining_tokens = G__22929;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22919){
var G__22920 = cljs.core.first.call(null,seq22919);
var seq22919__$1 = cljs.core.next.call(null,seq22919);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22920,seq22919__$1);
});
...
var vec__22933 = cljs.core.split_with.call(null,(function (p1__22932_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22932_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22933,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22933,(1),null);
...
var vec__22936 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22936,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22936,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22939 = cljs.core.rest.call(null,remaining_tokens);
var G__22940 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22939;
name_tokens = G__22940;
continue;
} else {
...
var vec__22943 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22943,(0),null);
var arity = cljs.core.nth.call(null,vec__22943,(1),null);
var vec__22946 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22946,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22946,(1),null);
var vec__22949 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22949,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22949,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22949,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22949,(3),null);
...
var vec__22955 = result;
var munged_ns = cljs.core.nth.call(null,vec__22955,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22955,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22955,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22955,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22955,(4),null);
var arity = cljs.core.nth.call(null,vec__22955,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__22959 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__22959,(0),null);
var args = cljs.core.nth.call(null,vec__22959,(1),null);
var vec__22962 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22962,(0),null);
var name = cljs.core.nth.call(null,vec__22962,(1),null);
...
var G__22965 = (arity + (1));
var G__22966 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22967){
var vec__22968 = p__22967;
var arity = cljs.core.nth.call(null,vec__22968,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22968,(1),null);
...
return cljs.core.get.call(null,arities,p1__22971_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__22972_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22975){
var vec__22976 = p__22975;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22976,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22973){
var G__22974 = cljs.core.first.call(null,seq22973);
var seq22973__$1 = cljs.core.next.call(null,seq22973);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22974,seq22973__$1);
});
...
var G__22982 = arg;
var G__22982__$1 = (((G__22982 instanceof cljs.core.Keyword))?G__22982.fqn:null);
switch (G__22982__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__22984__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22984__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22984__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22984__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22985 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22985,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22985,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22985,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22985,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22985,(4),null);
var arity = cljs.core.nth.call(null,vec__22985,(5),null);
...
var o__22017__auto__ = f;
return (o__22017__auto__["getBasis"]).call(o__22017__auto__);
});
/**
...
}catch (e22989){var _e__22024__auto__ = e22989;
...
var G__22990 = (obj[cljs.core.first.call(null,path)]);
var G__22991 = cljs.core.rest.call(null,path);
obj = G__22990;
path = G__22991;
continue;
} else {
...
return (function (accum,p__22992){
var vec__22993 = p__22992;
var bit = cljs.core.nth.call(null,vec__22993,(0),null);
var protocol = cljs.core.nth.call(null,vec__22993,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22996){
var vec__22997 = p__22996;
var ns = cljs.core.nth.call(null,vec__22997,(0),null);
var name = cljs.core.nth.call(null,vec__22997,(1),null);
var selector = cljs.core.nth.call(null,vec__22997,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__23002,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__23002,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__23002,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__23000_SHARP_){
return (obj[cljs.core.first.call(null,p1__23000_SHARP_)]);
});})(name,sorted_matches,vec__23002,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1529089805002
